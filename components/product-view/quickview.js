    ...
    return (
        <div className="bg-gray-800">
            <div className="px-4 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9">
                <div id="viewerButton" className="flex justify-center hidden w-full">
                    <button onclick="openView()" className="px-10 py-5 font-semibold text-indigo-600 bg-white rounded shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
                        Open Quick View
                    </button>
                </div>
                <div id="viewerBox" className="p-4 bg-white lg:p-10 md:p-6">
                    ...
                    <div className="flex flex-col items-stretch justify-center mt-3 md:mt-4 lg:mt-0 lg:flex-row lg:space-x-8">
                        <CarouselProvider naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={3} className="flex justify-between px-2 py-20 lg:w-1/2 items-strech bg-gray-50 md:py-6 md:px-6 lg:py-24">
                        ...
                        <div className="flex flex-col justify-center pb-8 lg:w-1/2 mt-7 md:mt-8 lg:mt-0 lg:pb-0">
                            <h1 className="text-3xl font-semibold text-gray-800 lg:text-4xl">Bar Stool</h1>
                            <p className="mt-2 text-base leading-normal text-gray-600">You don&apos;t just want to be comfortable sitting in a bar stool—you want to be comfortable shimmying it up to the bar, closer to your lover, or back slightly to include a third person in the conversation.</p>
                            <p className="mt-8 text-3xl font-medium text-gray-600 md:mt-10">$790</p>
                            <div className="flex flex-col items-center mt-8 space-y-4 md:flex-row md:space-y-0 md:space-x-6 lg:space-x-8 md:mt-16">
                                <button className="w-full py-6 text-base font-medium leading-none text-white uppercase bg-gray-800 border border-gray-800 md:w-3/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">Add to Cart</button>
                                <button className="w-full py-6 text-base font-medium leading-none text-gray-800 uppercase bg-transparent border border-gray-800 md:w-2/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-800 hover:text-white">View Details</button>
                            </div>
                            <div className="mt-6">
                                <button className="text-xl text-gray-800 underline capitalize hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">add to wishlist</button>
                            </div>
                        </div>
                    </div>
                </div>
