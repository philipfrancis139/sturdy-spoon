...
const ProductReview = () => {
    ...
    return (
        <div className="flex items-center justify-center px-4 py-12 md:px-6 2xl:px-0 2xl:container 2xl:mx-auto">
            <div className="flex flex-col items-start justify-start w-full space-y-8">
                <div className="flex items-start justify-start">
                    <p className="text-3xl font-semibold leading-7 text-gray-800 lg:text-4xl lg:leading-9">Reviews</p>
                </div>
                <div className="flex flex-col items-start justify-start w-full p-8 bg-gray-50">
                    <div className="flex flex-col justify-between w-full md:flex-row">
                        <div className="flex flex-row items-start justify-between">
                            <p className="text-xl font-medium leading-normal text-gray-800 md:text-2xl">Beautiful addition to the theme</p>
                    ...
                    <div className={"md:block " + (menu ? "block" : "hidden")}>
                        <p className="w-full mt-3 text-base leading-normal text-gray-600 md:w-9/12 xl:w-5/6">When you want to decorate your home, the idea of choosing a decorative theme can seem daunting. Some themes seem to have an endless amount of pieces, while others can feel hard to accomplish</p>
                        <div className="flex-row items-start justify-start hidden mt-6 space-x-4 md:flex">
                            <div>
                        ...
                        <div className="pt-8 md:hidden carousel cursor-none" data-flickity='{ "wrapAround": true,"pageDots": false }'>
                            <div className="carousel-cell">
                                <div className="relative h-full md:w-full">
                                    <img src="https://i.ibb.co/QXzVpHp/vincent-wachowiak-8g-Cm-EBVl6a-I-unsplash-1.png" alt="bag" className="object-cover w-full h-full object-fit" />
                                </div>
                            </div>
                            <div className="carousel-cell">
                                <div className="relative h-full md:w-full">
                                    <img src="https://i.ibb.co/znYKsbc/vincent-wachowiak-z-P316-KSOX0-E-unsplash-1.png" alt="shoes" className="object-cover w-full h-full object-fit" />
                                </div>
                            </div>
                            <div className="carousel-cell">
                                <div className="relative h-full md:w-full">
                                    <img src="https://i.ibb.co/QXzVpHp/vincent-wachowiak-8g-Cm-EBVl6a-I-unsplash-1.png" alt="wallet" className="object-cover w-full h-full object-fit" />
                                </div>
                            </div>
                            <div className="carousel-cell">
                                <div className="relative h-full md:w-full">
                                    <img src="https://i.ibb.co/znYKsbc/vincent-wachowiak-z-P316-KSOX0-E-unsplash-1.png" alt="wallet" className="object-cover w-full h-full object-fit" />
                                </div>
                            </div>
                            <div className="carousel-cell">
                                <div className="relative h-full md:w-full">
                    ...
                    <div className="flex flex-col items-start justify-start w-full py-8 bg-gray-50 md:px-8">
                        <div className="flex flex-col justify-between w-full md:flex-row">
                            <div className="flex flex-row items-start justify-between">
                                <p className="text-xl font-medium leading-normal text-gray-800 md:text-2xl">Comfortable and minimal, just how I like it!</p>
                        ...
                        <div className={"md:block " + (menu1 ? "block" : "hidden")}>
                            <p className="w-full mt-3 text-base leading-normal text-gray-600 md:w-9/12 xl:w-5/6">This style relies more on neutral colors with little to no embellishment on furniture. Lighter fabrics, such as silk and cotton, are popular, as are lighter colors in wood and metal.</p>
                            <div className="flex flex-row items-start justify-start mt-6 space-x-4">
