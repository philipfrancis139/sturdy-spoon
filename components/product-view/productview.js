        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              {/* Shop Now */}
              <div className="w-full my-2 px-2 text-dark-600 md:w-1/3">
                  <Link
                    className="flex items-center justify-center w-full px-2 py-4 text-xl font-medium leading-8 tracking-tighter text-center bg-blue-400 text-dark-800 font-heading focus:ring-2 focus:ring-gray-200 focus:ring-opacity-50 hover:bg-opacity-60 rounded-xl"
                    href="#"
                  >
                    Shop Now 
              ...
              <div className="w-full my-2 px-2 text-dark-600 md:w-1/3">
                ...
                {/* input of pin  */}
                <div className="pin w-full my-2 px-2 text-dark-600 md:w-1/3">
                <input
                onChange={onChangePin}
                type="text"
                placeholder="712410"
                  className="flex items-center justify-center w-full border-2 px-2 py-1 text-xl border-blue-500 outline-none font-medium leading-8 tracking-tighter text-center bg-light-600 text-dark-800 font-heading focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50  rounded-xl"
                />
                </div>
