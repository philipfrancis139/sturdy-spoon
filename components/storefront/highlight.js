        ...
        <div className="2xl:container 2xl:mx-auto md:py-12 py-9">
            <div className="grid grid-cols-1 px-4 py-10 bg-gray-50 lg:grid-cols-4 md:grid-cols-2 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 md:px-12">
                ...
                <div>
                    ...
                    <h3 className="mt-8 text-xl font-semibold leading-5 text-gray-800 lg:mt-10">Delivery</h3>
                    <p className="w-full mt-4 text-base font-normal leading-6 text-gray-600 lg:w-full md:w-9/12">Free worldwide delivery over orders above $100</p>
                </div>
                ...
                <div>
                    ...
                    <h3 className="mt-8 text-xl font-semibold leading-5 text-gray-800 lg:mt-10">Customer Care</h3>
                ...
                <div>
                    ...
                    <p className="w-full mt-4 text-base font-normal leading-6 text-gray-600 lg:w-full md:w-9/12">All out products are 100 percent recycable</p>
                </div>
                ...
                <div>
                    ...
                    <h3 className="mt-8 text-xl font-semibold leading-5 text-gray-800 lg:mt-10">Secure Payment</h3>
                    <p className="w-full mt-4 text-base font-normal leading-6 text-gray-600 lg:w-full md:w-9/12">Transaction process has end to end encryption</p>
                </div>
            </div>
        </div>
    );
