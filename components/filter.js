        ...
        <div className="2xl:container 2xl:mx-auto">
            <div className="px-4  md:py-12 lg:px-20 md:px-6 py-9">
                ...
                <div className="flex items-center justify-between mb-4 ">
                    ...
                    <button onClick={() => setShowfilters(!showFilters)} className="flex items-center justify-center hidden px-6 py-4 text-base font-normal leading-4 text-white bg-gray-800 cursor-pointer  sm:flex hover:bg-gray-700 focus:ring focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">
