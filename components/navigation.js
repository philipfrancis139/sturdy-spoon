...
const unaessthetic = localFont({
  src: "../fonts/unaessthetic/ttf/unaessthetic-unaessthetic-400.ttf",
});
...
const navigation = {
  ...
  pages: [
    { name: "Tending", href: "/trending" },
    { name: "New Arrivals", href: "/newarival" },
  ],
};
...
const Navigation = ({
  ...
  return (
    <div className="sticky z-20 drop-shadow -top-2 bg-slate-600">
      {/* Mobile menu */}
        ...
        >
          <div className="border-b border-gray-200">
            <div className="flex items-center h-16">
              ...
              <div
                className={`${unaessthetic.className} ${styles.logo} ml-3 text-4xl text-transparent bg-gradient-to-r from-violet-400 via-sky-400 to-teal-400 bg-clip-text `}
              >
                      ...
                      {({ open }) => (
                        <>
                          ...
                          <Transition
                            ...
                            leaveTo="opacity-0"
                          >
                            <Popover.Panel className="absolute inset-x-0 z-50 text-sm text-gray-500 top-full">
              ...
              <div className="flex items-center ml-auto">
                ...
                {/* Cart */}
                <div className="top-0 flow-root ml-4 lg:ml-6">
                  <Link href="#" className="flex items-center p-2 -m-2 group">
                    <Cart
                      cart={cart}
                      addToCart={addToCart}
