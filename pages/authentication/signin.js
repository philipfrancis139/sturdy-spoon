...
function MyApp() {
    ...
    return (
        <div className="w-full h-full px-4 py-16 bg-gradient-to-tl from-slate-950 to-gray-800">
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="w-full p-10 mt-16 bg-black rounded shadow lg:w-1/3 md:w-1/2">
                    <p
                        tabIndex={0}
                        role="heading"
                    ...
                    <p className="mt-4 text-base font-medium leading-none text-gray-500">
                        Dont have account?{" "}
                        <Link href='./signup'>
                        <span
                            tabIndex={0}
                    ...
                    <button
                        ...
                        role="button"
                        className="hover:bg-gray-50 duration-150 active:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10"
                    >
                        <svg
                            width={19}
                            height={20}
                    ...
                    <button
                        ...
                        role="button"
                        className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-50 duration-150 active:bg-gray-100"
                    >
                        <svg
                            width={21}
                            height={20}
                    ...
                    <button
                        ...
                        role="button"
                        className="hover:bg-gray-50 duration-150 active:bg-gray-100 focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4"
                    >
                        <svg
                            width={24}
                            height={24}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            role="input"
                            type="email"
                            className="w-full py-3 pl-3 mt-2 text-xs font-medium leading-none text-gray-800 bg-gray-900 border rounded focus:outline-none"
                        />
                    </div>
                    <div className="w-full mt-6">
                        <lable className="text-sm font-medium leading-none text-slate-800">
                            Password
                        </lable>
                    ...
                    <div className="mt-8">
                        <button
                            ...
                            className="w-full py-4 text-sm font-semibold leading-none text-white bg-indigo-700 border rounded-md focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none hover:bg-indigo-600"
                        >
                            Create my account
                        </button>
                    </div>
